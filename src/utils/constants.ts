...
export const CHAINS: Chains = {
  "0xaa36a7": {
    ...
    subgraphEndpoint:
      "https://api.studio.thegraph.com/query/60908/neper-sepolia/version/latest",
    contracts: {
  ...
  "0x66eee": {
    ...
    currency: { name: "ETH", symbol: "ETH", decimals: 18 },
    subgraphEndpoint:
      "https://api.studio.thegraph.com/query/64179/nepercore/version/latest",
    contracts: {
      neperCore: "0xCEe292A378779de235c7b0fCA7B9817F43631e3E",
      neperUSD: "0x8499CAf687737Fd622d184854521e6410510c402",
      wbtc: "0x72E4c266683ebD4f63125EDAc3eB76eaD0D7ee7e",
      stabilityPool: "0x0d0f8a5f0c2f4d3a8d6c8e8b0a1b7d9f1c5f8d9e",
    },
  },
  "0x5a2": {
    ...
    currency: { name: "ETH", symbol: "ETH", decimals: 18 },
    subgraphEndpoint:
      "https://api.studio.thegraph.com/query/60908/neper-polygon/version/latest",
    contracts: {
  ...
  "0x8274f": {
    ...
    currency: { name: "ETH", symbol: "ETH", decimals: 18 },
    subgraphEndpoint:
      "https://api.studio.thegraph.com/query/60908/neper-scroll/version/latest",
    contracts: {
  ...
  "0x14a33": {
    ...
    currency: { name: "ETH", symbol: "ETH", decimals: 18 },
    subgraphEndpoint:
      "https://api.studio.thegraph.com/query/60908/neper-base/version/latest",
    contracts: {
      neperCore: "0x9666242Cc04Be9BFbc6165640Ce23208aEb4398a",
      neperUSD: "0xd449bb18c6020296ff0f790c4758bbbd5fec675b",
      wbtc: "",
  ...
  "0xAef3": {
    ...
    subgraphEndpoint:
      "https://api.studio.thegraph.com/query/60908/neper-celo/version/latest",
    contracts: {
      neperCore: "0x9666242Cc04Be9BFbc6165640Ce23208aEb4398a",
      neperUSD: "0xd449bb18c6020296ff0f790c4758bbbd5fec675b",
      wbtc: "",
