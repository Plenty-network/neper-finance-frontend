...
import { StaticRow, StaticAmounts } from "../../../Vault/Editor";
      ...
      <Box sx={{ mt: 3 }}>
        ...
        <StaticRow label="Pool balance ratio">
          ...
          >
            ...
            <PoolBalance symbol="pUSD-3CRV">{poolBalanceRatio.prettify(2)}</PoolBalance>
          </StaticAmounts>
        </StaticRow>
