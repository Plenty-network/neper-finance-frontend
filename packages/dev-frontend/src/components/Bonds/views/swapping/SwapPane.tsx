...
const tokenSymbol: Record<BLusdAmmTokenIndex.BLUSD | BLusdAmmTokenIndex.pUSD, string> = {
  [BLusdAmmTokenIndex.BLUSD]: "bLUSD",
  [BLusdAmmTokenIndex.pUSD]: "pUSD"
};

const outputToken: Record<
  BLusdAmmTokenIndex.BLUSD | BLusdAmmTokenIndex.pUSD,
  BLusdAmmTokenIndex.BLUSD | BLusdAmmTokenIndex.pUSD
> = {
  [BLusdAmmTokenIndex.BLUSD]: BLusdAmmTokenIndex.pUSD,
  [BLusdAmmTokenIndex.pUSD]: BLusdAmmTokenIndex.BLUSD
};
