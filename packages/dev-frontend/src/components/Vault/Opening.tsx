...
const EMPTY_TROVE = new Vault(Decimal.ZERO, Decimal.ZERO);
...
export const Opening: React.FC = () => {
  ...
  const trove = isDirty ? new Vault(collateral, totalDebt) : EMPTY_TROVE;
  ...
  return (
    <Card>
      ...
      <Box sx={{ p: [2, 3] }}>
        ...
        {description ?? (
          <ActionDescription>
            Start by entering the amount of WBTC you'd like to deposit as collateral.
          </ActionDescription>
        )}
